...
class MainActivity : AppCompatActivity() {
    ...
    val academyimg = mutableListOf(R.drawable.millennium, R.drawable.gehenna, R.drawable.abydos, R.drawable.trinity, R.drawable.hyakkiyoako, R.drawable.shanhaijing, R.drawable.red_winter,R.drawable.valkyrie, R.drawable.srt, R.drawable.arius)
